...
/* ********  E N C O D I N G   M E T H O D S  ******** */
    ...
    public static String encodeObject(java.io.Serializable serializableObject, int options) throws java.io.IOException {
        ...
        try {
            // ObjectOutputStream -> (GZIP) -> com.yahoo.util.Base64 -> ByteArrayOutputStream
            // Note that the optional GZIPping is handled by com.yahoo.util.Base64.OutputStream.
    ...
    public static byte[] encodeBytesToBytes(byte[] source, int off, int len, int options) throws java.io.IOException {
        ...
        if((options & GZIP) > 0) {
            ...
            try {
                // GZip -> com.yahoo.util.Base64 -> ByteArray
                baos = new java.io.ByteArrayOutputStream();
                b64os = new Base64.OutputStream(baos, ENCODE | options);
...
/* ********  D E C O D I N G   M E T H O D S  ******** */
    ...
    public static byte[] decode(byte[] source, int off, int len, int options) throws java.io.IOException {
        ...
        if(len == 0) {
            ...
            throw new IllegalArgumentException("com.yahoo.util.Base64-encoded string must have at least four characters, but length specified was " + len);
        }   // end if
        ...
        for(i = off; i < off + len; i++) {  // Loop through source
            ...
            // White space, Equals sign, or legit com.yahoo.util.Base64 character
            ...
            if(sbiDecode >= WHITE_SPACE_ENC) {
                ...
                // There's a bad input character in the com.yahoo.util.Base64 stream.
                throw new java.io.IOException(String.format("Bad com.yahoo.util.Base64 input character '%c' in array position %d", source[i], i));
            }   // end else:
    ...
    public static class InputStream extends java.io.FilterInputStream {
        ...
        public int read() throws java.io.IOException {
            ...
            if(position < 0) {
                ...
                // Else decoding
                    ...
                    if(i == 4) {
                        ...
                        throw new java.io.IOException("Improperly padded com.yahoo.util.Base64 input.");
                    }   // end
            ...
            // Else error
                ...
                throw new java.io.IOException("Error in com.yahoo.util.Base64 code reading stream.");
            }   // end else
        }   // end read
    ...
    public static class OutputStream extends java.io.FilterOutputStream {
        ...
        public void write(int theByte) throws java.io.IOException {
            ...
            // Else, Decoding
                ...
                // Meaningful com.yahoo.util.Base64 character?
                if(decodabet[theByte & 0x7f] > WHITE_SPACE_ENC) {
                    ...
                    throw new java.io.IOException("Invalid character in com.yahoo.util.Base64 data.");
        ...
        public void flushBase64() throws java.io.IOException {
            if(position > 0) {
                if(encode) {
                    ...
                    throw new java.io.IOException("com.yahoo.util.Base64 input not properly padded.");
                }   // end else: decoding
...
}   // end class com.yahoo.util.Base64